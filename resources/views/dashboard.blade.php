                ...
                <div class="p-6 text-gray-900">
                  <form action="{{ route('merchants.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="owner" id="owner" placeholder="Owner" class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="{{ old('owner') }}">
                        @error('owner')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="employee" id="employee" class="bg-gray-100 border-2 w-full p-4 rounded-lg">
                            ...
                            <option value="small">Small Business: Typically 1-50 employees</option>
                            <option value="medium">Medium Business: 51-250 employees</option>
                            <option value="large">Large Business: 251+ employees</option>
                        </select>
                    </div>
